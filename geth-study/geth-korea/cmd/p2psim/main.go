...
// 저작권 2017 go-ethereum 작성자
// 이 파일은 go-ethereum의 일부입니다.
//
// go-ethereum는 다음과 같은 조건에 따라 재배포하거나 수정할 수 있습니다.
// GNU 일반 공중 사용 허가서의 3 버전 또는
// (귀하의 선택에 따라) 이후 버전.
//
// go-ethereum는 유용할 수 있지만 어떠한 보증도 없으며,
// 상업성 또는 특정 용도에 대한 암시적 보증을 포함하여 어떤 종류의 보증도 없습니다.
// 자세한 내용은 GNU 일반 공중 사용 허가서를 참조하십시오.
//
// go-ethereum와 함께 GNU 일반 공중 사용 허가서의 사본을받아야합니다.
// 그렇지 않으면 http://www.gnu.org/licenses/을 참조하십시오.
//
// p2psim은 시뮬레이션 HTTP API를위한 명령 줄 클라이언트를 제공합니다.
//
// 다음은 첫 번째 노드가 두 번째 노드에 연결된 2 개 노드 네트워크를 만드는 예입니다.
package main
