...
func (_Token *TokenTransactor) TransferFrom(opts *bind.TransactOpts, spender common.Address, recipient common.Address, amount *big.Int) (*types.Transaction, error) {
	return _Token.contract.Transact(opts, "transferFrom", spender, recipient, amount)
}

// TransferFrom is a paid mutator transaction binding the contract method 0x23b872dd.
//
// Solidity: function transferFrom(address spender, address recipient, uint256 amount) returns(bool)
func (_Token *TokenSession) TransferFrom(spender common.Address, recipient common.Address, amount *big.Int) (*types.Transaction, error) {
	return _Token.Contract.TransferFrom(&_Token.TransactOpts, spender, recipient, amount)
}

// TransferFrom is a paid mutator transaction binding the contract method 0x23b872dd.
//
// Solidity: function transferFrom(address spender, address recipient, uint256 amount) returns(bool)
func (_Token *TokenTransactorSession) TransferFrom(spender common.Address, recipient common.Address, amount *big.Int) (*types.Transaction, error) {
	return _Token.Contract.TransferFrom(&_Token.TransactOpts, spender, recipient, amount)
}
...
//
// Solidity: event Approval(address indexed owner, address indexed spender, uint256 oldAmount, uint256 amount)
...
// TokenTransfer0Iterator is returned from FilterTransfer0 and is used to iterate over the raw logs and unpacked data for Transfer0 events raised by the Token contract.
type TokenTransfer0Iterator struct {
	Event *TokenTransfer0 // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *TokenTransfer0Iterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *TokenTransfer0Iterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *TokenTransfer0Iterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// TokenTransfer0 represents a Transfer0 event raised by the Token contract.
type TokenTransfer0 struct {
	Spender common.Address
	From    common.Address
	To      common.Address
	Amount  *big.Int
...
// FilterTransfer0 is a free log retrieval operation binding the contract event 0xd1398bee19313d6bf672ccb116e51f4a1a947e91c757907f51fbb5b5e56c698f.
//
// Solidity: event Transfer(address indexed spender, address indexed from, address indexed to, uint256 amount)
func (_Token *TokenFilterer) FilterTransfer0(opts *bind.FilterOpts, spender []common.Address, from []common.Address, to []common.Address) (*TokenTransfer0Iterator, error) {
	...
	logs, sub, err := _Token.contract.FilterLogs(opts, "Transfer0", spenderRule, fromRule, toRule)
	if err != nil {
		return nil, err
	}
	return &TokenTransfer0Iterator{contract: _Token.contract, event: "Transfer0", logs: logs, sub: sub}, nil
}

// WatchTransfer0 is a free log subscription operation binding the contract event 0xd1398bee19313d6bf672ccb116e51f4a1a947e91c757907f51fbb5b5e56c698f.
//
// Solidity: event Transfer(address indexed spender, address indexed from, address indexed to, uint256 amount)
func (_Token *TokenFilterer) WatchTransfer0(opts *bind.WatchOpts, sink chan<- *TokenTransfer0, spender []common.Address, from []common.Address, to []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Token.contract.WatchLogs(opts, "Transfer0", spenderRule, fromRule, toRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(TokenTransfer0)
				if err := _Token.contract.UnpackLog(event, "Transfer0", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseTransfer0 is a log parse operation binding the contract event 0xd1398bee19313d6bf672ccb116e51f4a1a947e91c757907f51fbb5b5e56c698f.
//
// Solidity: event Transfer(address indexed spender, address indexed from, address indexed to, uint256 amount)
func (_Token *TokenFilterer) ParseTransfer0(log types.Log) (*TokenTransfer0, error) {
	event := new(TokenTransfer0)
	if err := _Token.contract.UnpackLog(event, "Transfer0", log); err != nil {
		return nil, err
	}
